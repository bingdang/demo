...
type MessageSenderClient interface {
	Send(ctx context.Context, in *MessageReq, opts ...grpc.CallOption) (*MessageReply, error)
}
...
func (c *messageSenderClient) Send(ctx context.Context, in *MessageReq, opts ...grpc.CallOption) (*MessageReply, error) {
...
type MessageSenderServer interface {
	Send(context.Context, *MessageReq) (*MessageReply, error)
...
func (UnimplementedMessageSenderServer) Send(context.Context, *MessageReq) (*MessageReply, error) {
...
func _MessageSender_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageSenderServer).Send(ctx, req.(*MessageReq))
	}
